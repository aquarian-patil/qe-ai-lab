...
export default function AuditPage() {
  ...
  return (
    <div className="h-full m-4 flex flex-col relative overflow-hidden glass-panel">
      <header className="px-8 py-6 border-b border-slate-300 bg-slate-50 flex justify-between items-center">
        <div>
      ...
      <div className="flex-1 overflow-hidden p-8">
        <div className="w-full h-full rounded-xl border border-slate-300 bg-slate-100 overflow-hidden flex flex-col">
          ...
          <div className="grid grid-cols-5 gap-4 px-6 py-4 border-b border-slate-300 bg-slate-100 text-xs uppercase tracking-widest font-bold text-slate-800">
            <div>Timestamp</div>
            <div>Actor</div>
