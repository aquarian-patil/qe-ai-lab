        ...
        <div className="w-full lg:w-[55%] flex flex-col relative shrink-0 lg:h-full min-w-0">
          <div className="flex-1 border border-slate-700 rounded-xl bg-slate-900 shadow-sm p-4 md:p-6 flex flex-col">
            ...
            <div className="flex flex-col gap-5 flex-1 overflow-y-auto pr-2 custom-scrollbar">
              ...
              <div className="flex flex-col shrink-0">
                <h4 className="text-[10px] md:text-[11px] font-bold text-slate-400 uppercase tracking-widest mb-2">Participating Agents</h4>
              ...
              <div key={evt.id} className="animate-slide-up bg-slate-900 border border-slate-800 p-4 rounded-xl flex gap-4">
                ...
                <div className="flex-1 flex flex-col gap-1.5">
                  <div className="flex items-center justify-between">
                    <span className={`font-bold text-xs md:text-sm ${evt.color}`}>{evt.agent}</span>
                    <span className="text-[8px] md:text-[10px] font-bold text-slate-400 uppercase tracking-widest px-2 py-0.5 rounded-full bg-slate-800">{evt.role}</span>
                  </div>
                  <span className="text-slate-300 text-xs md:text-sm leading-relaxed">{evt.message}</span>
                </div>
              </div>
            ))}
