            ...
            <div className="flex-1 flex flex-col overflow-hidden animate-slide-up">
              ...
              <div className="mt-4 p-4 rounded-xl border border-dashed border-blue-500/30 bg-blue-500/5 flex items-center justify-between animate-slide-up delay-300 flex-shrink-0">
                ...
                <div className="flex flex-wrap gap-2 mt-4 md:mt-0">
                  <Link href="/sandboxes/gen-ai" title="Best for validating BDD Docs & SQL" className="px-3 py-1.5 rounded-lg bg-slate-100 border border-blue-500/20 hover:border-blue-400 hover:bg-blue-500/10 text-xs text-slate-800 transition-all text-center">
                    Evaluate Logic
                  </Link>
