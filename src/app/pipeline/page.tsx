  ...
  return (
    <div className="h-full flex flex-col relative overflow-y-auto lg:overflow-hidden glass-panel !border-0 md:!border !rounded-none md:!rounded-2xl">
      ...
      <div className="flex-1 flex flex-col xl:flex-row overflow-y-auto lg:overflow-hidden min-w-0 w-full">
        ...
        <div className="w-full xl:flex-1 h-[250px] sm:h-[300px] xl:h-auto xl:min-h-[400px] p-0 md:p-8 border-b xl:border-b-0 xl:border-r border-slate-700 relative bg-slate-950 overflow-hidden flex items-start xl:items-center justify-center min-w-0">
