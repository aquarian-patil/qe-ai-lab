...
export default function Dashboard() {
  ...
  return (
    <div className="m-4 flex flex-col gap-6 relative pb-8">
      <header className="px-8 py-6 glass-panel flex justify-between items-center relative overflow-hidden shrink-0">
        <div className="absolute inset-0 bg-gradient-to-r from-violet-500/10 to-blue-500/10" />
        <div className="relative z-10">
          <h2 className="text-3xl font-black text-slate-900 tracking-tight">Executive Command Center</h2>
          <p className="text-sm text-slate-800 mt-1">Holistic DevSecOps Maturity & Autonomous Ecosystem Status</p>
        </div>
        <div className="flex gap-4 relative z-10">
          <Link href="/audit" className="px-6 py-2 rounded-lg bg-slate-200 hover:bg-slate-300 text-slate-900 font-bold text-sm transition-colors border border-slate-300 flex items-center">
            View Audit Log
          </Link>
          <Link href="/genesis" className="px-6 py-2 rounded-lg bg-blue-600 hover:bg-blue-500 text-white font-bold text-sm shadow-[0_0_20px_rgba(6,182,212,0.3)] transition-all flex items-center">
      ...
      <div className="flex gap-6 h-[400px] shrink-0">
        ...
        {/* Current Score */}
        <div className="w-[300px] glass-panel p-6 flex flex-col items-center justify-center relative overflow-hidden group">
          ...
          <div className="relative z-10 text-center">
            ...
            <h1 className="text-7xl font-black text-slate-900 drop-shadow-[0_0_15px_rgba(255,255,255,0.5)] mb-2">
